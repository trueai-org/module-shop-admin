                            ...
                            <Tabs type="card" onChange={this.handleTabChange}>
                                <TabPane tab="基本信息" key="1">
                                    ...
                                    <FormItem
                                        ...
                                        })(<InputNumber style={{ width: '100%' }} min={0} allowClear placeholder="付款金额" />)}
                                    </FormItem>
                                    <FormItem
                                        {...formItemLayout}
                                        label={<span>付款时间</span>}>
                                        {getFieldDecorator('paymentOn', {
                                            initialValue: this.state.current.paymentOn ? moment(this.state.current.paymentOn, "YYYY-MM-DD HH:mm:ss") : null,
                                        })(
                                            <DatePicker
                                                showTime
                                    ...
                                    <FormItem
                                        {...formItemLayout}
                                        label={<span>发货时间</span>}>
                                        {getFieldDecorator('shippedOn', {
                                            initialValue: this.state.current.shippedOn ? moment(this.state.current.shippedOn, "YYYY-MM-DD HH:mm:ss") : null,
                                        })(
                                            <DatePicker
                                                showTime
                                                format="YYYY-MM-DD HH:mm:ss"
                                    ...
                                    <FormItem
                                        {...formItemLayout}
                                        label={<span>收货时间</span>}>
                                        {getFieldDecorator('deliveredOn', {
                                            initialValue: this.state.current.deliveredOn ? moment(this.state.current.deliveredOn, "YYYY-MM-DD HH:mm:ss") : null,
                                        })(
                                            <DatePicker
                                                showTime
                                                format="YYYY-MM-DD HH:mm:ss"
                                    ...
                                    <FormItem
                                        {...formItemLayout}
                                        label={<span>交易取消时间</span>}>
                                        {getFieldDecorator('cancelOn', {
                                            initialValue: this.state.current.cancelOn ? moment(this.state.current.cancelOn, "YYYY-MM-DD HH:mm:ss") : null,
                                        })(
                                            <DatePicker
                                                showTime
                                                format="YYYY-MM-DD HH:mm:ss"
                                    ...
                                    <FormItem
                                        {...formItemLayout}
                                        label={<span>交易取消原因</span>}>
                                        {getFieldDecorator('cancelReason', { initialValue: this.state.current.cancelReason || '' })(
                                            <TextArea
                                                style={{ minHeight: 32 }}
                                ...
                                <TabPane tab="配送 & 账单" key="2">
                                    <Card type="inner" title="配送地址">
                                                    ...
                                                    <RadioGroup onChange={(e) => {
                                                        ...
                                                        <Radio style={radioStyle} value={''}>无</Radio>
                                                        {
                                                            this.state.current.shippingAddressId ?
                                                                <Radio key={this.state.current.shippingAddressId} style={radioStyle} value={this.state.current.shippingAddressId}>配送地址</Radio>
                                                                : <Radio style={radioStyle} value={0}>新地址</Radio>
                                                        }
                                                    </RadioGroup>
                                                )
                                            }
                                        ...
                                        {
                                            this.state.defaultShippingAddressId || this.state.defaultShippingAddressId === 0 ?
                                                <div>
                                                    <FormItem
                                                        {...formItemLayout}
                                                        label={<span>联系人</span>}>
                                    ...
                                    <Card type="inner" title="账单地址"
                                                    ...
                                                    <RadioGroup onChange={(e) => {
                                                        ...
                                                        <Radio style={radioStyle} value={''}>无</Radio>
                                                        {
                                                            this.state.current.billingAddressId ?
                                                                <Radio key={this.state.current.billingAddressId} style={radioStyle} value={this.state.current.billingAddressId}>账单地址</Radio>
                                                                : <Radio style={radioStyle} value={0}>新地址</Radio>
                                                        }
                                                    </RadioGroup>)
                                            }
                                        ...
                                        {
                                            this.state.defaultBillingAddressId === 0 || this.state.defaultBillingAddressId ?
                                                <div>
                                                    <FormItem
                                                        {...formItemLayout}
                                                        label={<span>联系人</span>}>
                                                    ...
                                                    <FormItem
                                                        ...
                                                        {getFieldDecorator('billingAddress.stateOrProvinceId', {
                                                            ...
                                                            rules: [{ required: true, message: '请选择省市区' }],
                                                        })(<Cascader changeOnSelect options={this.state.provinces2} placeholder="Please select" />)}
                                                    </FormItem>
                                                    <FormItem
                                                        {...formItemLayout}
                                                        label={<span>城市</span>}>
